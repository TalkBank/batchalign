# Dutch processing reference

The transcription language code is `nld`. For morphology, use the appropriate
CHAT `@Languages:` header; there is no morphotag `--lang` option.

Contractions and apostrophes should be checked against the shared tokenizer and renderer.
...
The [earlier Dutch study](https://github.com/TalkBank/batchalign/blob/fbaee727d9649f8d4bf1592433fb71f7acce7b12/book/src/batchalign/reference/languages/dutch.md)
