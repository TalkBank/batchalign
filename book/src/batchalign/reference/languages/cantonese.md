# Cantonese processing reference

The transcription language code is `yue`. For morphology, use the appropriate
CHAT `@Languages:` header; there is no morphotag `--lang` option.

The current Stanza language mapping uses Traditional Chinese. This does not establish Cantonese model accuracy. See [Process Cantonese](../../user-guide/cantonese-processing.md) for command examples.
...
The [earlier Cantonese study](https://github.com/TalkBank/batchalign/blob/fbaee727d9649f8d4bf1592433fb71f7acce7b12/book/src/batchalign/reference/languages/cantonese.md)
